...
preco DECIMAL (10, 2),
id_destino INT,
FOREIGN KEY (id_destino) REFERENCES Destinos(id _destino)
);
...
id_pagamento INT PRIMARY KEY AUTO_INCREMENT, id_reserva INT,
valor DECIMAL (10, 2),
data pagamento DATE,
FOREING KEY (id_ reserva) REFERENCES Reservas (id_reserva)
);
